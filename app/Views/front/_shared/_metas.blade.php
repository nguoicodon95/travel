...
<title>{{ $pageTitle or 'Trang chủ' }} | {{ $CMSSettings['site_title'] or '' }}</title>
<meta name="description" content="{{ $metaSEO['description'] or '' }}"/>
<meta name="keywords" content="{{ $metaSEO['keywords'] or '' }}"/>
<meta content="{{ $CMSSettings['email'] or '' }}" name="author"/>
...
<meta property="article:published_time"
      content="{{ (isset($object) && isset($object->created_at)) ? $object->created_at : date('Y-m-d H:i:s') }}"/>
<meta property="article:modified_time"
      content="{{ (isset($object) && isset($object->updated_at)) ? $object->updated_at : date('Y-m-d H:i:s') }}"/>
