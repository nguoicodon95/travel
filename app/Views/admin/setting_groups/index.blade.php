    ...
    <script>
        $(document).ready(function(){
            TableDatatablesAjax.init({
                ajaxGet: '{{ asset($adminCpAccess.'/setting-groups') }}',
                src: $('#datatable_ajax'),
                ...
                editableFields: [2, 3],
                actionPosition: 5,
                ajaxUrlSaveRow: '{{ asset($adminCpAccess.'/setting-groups/fast-edit') }}'
            });
        });
    </script>
@endsection
            ...
            <div class="portlet light portlet-fit portlet-datatable bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase">All group setting</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <a class="btn btn-transparent btn-success btn-circle btn-sm active" href="{{ asset($adminCpAccess.'/setting-groups/edit/0/') }}"><i class="fa fa-plus"></i> Create</a>
                        </div>
                    </div>
                </div>
