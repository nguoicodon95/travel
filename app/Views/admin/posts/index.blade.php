                    ...
                    <div class="table-container">
                        <div class="table-actions-wrapper">
                            ...
                            <select class="table-group-action-input form-control input-inline input-small input-sm">
                                ...
                                <option value="set_as_popular">Thiết lập nổi bật</option>
                                <option value="unset_as_popular">Hủy nổi bật</option>
                                <option value="set_as_favourite">Được yêu thích</option>
                                <option value="unset_as_favourite">Hủy yêu tích</option>
                            </select>
