    ...
    <script>
        $(document).ready(function(){
            TableDatatablesAjax.init({
                ...
                editableFields: [2, 3],
                actionPosition: 5,
                ajaxUrlSaveRow: '{{ asset($adminCpAccess.'/menus/fast-edit') }}'
            });
        });
    </script>
@endsection
                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <a class="btn btn-transparent btn-success btn-circle btn-sm" href="{{ asset($adminCpAccess.'/menus/edit/0/') }}"><i class="fa fa-plus"></i> Create</a>
                        </div>
                    </div>
                </div>
