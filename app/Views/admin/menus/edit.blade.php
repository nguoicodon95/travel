...
@section('content')
    ...
    <div class="note note-danger">
        <p><label class="label label-danger">NOTE</label>
          Để sử dụng mega menu thì cssClass của lớp cha thêm <code>dropdown mega-dropdown</code>.
          Menu cấp bình thường thì cssClass của lớp cha thêm <code>dropdown</code> .
        </p>
    </div>
