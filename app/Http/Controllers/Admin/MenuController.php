...
class MenuController extends BaseAdminController
{
    ...
    public function getEdit(Request $request, Menu $object, MenuNode $objectNode, Models\Category $category, Models\ProductCategory $productCategory, $id)
    {
        $oldInputs = old();
        if ($oldInputs && $id == 0) {
        ...
        $this->dis['nestableMenuSrc'] = $this->_getNestableMenuSrc($menu, 0);
        return $this->_viewAdmin('menus.edit', $this->dis);
    }

    public function postEdit(Request $request, Menu $object, MenuNode $objectNode, $id)
    {   
        ...
        $this->_recursiveSaveMenu($menuNodesJson, $id, 0);
