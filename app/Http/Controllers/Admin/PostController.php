...
class PostController extends BaseAdminController
{
    ...
    public function postIndex(Request $request, Post $object)
    {
        ...
        foreach ($items as $key => $row) {
            ...
            if ($row->is_favourite != 0) {
                $favourite = '<span class="label label-success label-sm">Favourite</span>';
            }
    ...
    public function getEdit(Request $request, Post $object, $id)
    {
        ...
        if (!$id == 0) {
            ...
            $customFieldBoxes = $customFieldBoxes->getCustomFieldsBoxes($id, $args, 'post');
